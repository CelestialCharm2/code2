...
local combined = {"Arceus", "Azelf", "Calyrex", "Celebi", "Cobalion", "Cosmoem", "Cosmog", "Cresselia", "Darkrai", "Deoxys", "Dialga", "Diancie", "Entei", "Eternatus", "Genesect", "Giratina", "Glastrier", "Groudon", "Heatran", "Ho-Oh", "Hoopa", "Jirachi", "Keldeo", "Kubfu", "Kyogre", "Kyurem", "Landorus", "Latias", "Latios", "Lugia", "Lunala", "Magearna", "Meloetta", "Manaphy", "Marshadow", "Melmetal", "Meltan", "Mesprit", "Mew", "Mewtwo", "Necrozma", "Type: Null", "Palkia", "Phione", "Raikou", "Rayquaza", "Regice", "Regidrago", "Regieleki", "Regigigas", "Regirock", "Registeel", "Reshiram", "Shaymin", "Silvally", "Solgaleo", "Spectrier", "Suicune", "Tapu Bulu", "Tapu Fini", "Tapu Koko", "Tapu Lele", "Terrakion", "Thundurus", "Tornadus", "Uxie", "Victini", "Virizion", "Volcanion", "Xerneas", "Yveltal", "Zacian", "Zamazenta", "Zarude", "Zekrom",
	"Zeraora", "Zygarde", "Urshifu", "Nihilego", "Guzzlord", "Xurkitree", "Celesteela", "Kartana", "Buzzwole", "Pheromosa", "Naganadel", "Poipole", "Blacephalon", "Stakataka", ""
}
...
local WHITELISTED = {
	...
	"Lugia",
	"Groudon", "Kyogre",
	"Regirock", "Regice", "Registeel", "Latias", "Latios", "Heatran",
	"Landorus",
	"Jirachi", "Shaymin", "Victini", "Genesect", "Keldeo", "Diancie", "Volcanion", "Zeraora",
					}
