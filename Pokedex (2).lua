return function(_p)--local _p = require(script.Parent.Parent)--game:GetService('ReplicatedStorage').Plugins)
	...
	local pokedex = {}
	local N_MAX_DEX = 1025

	local function color(r, g, b)
		return Color3.new(r/255, g/255, b/255)
	end

	local BACKGROUND_COLOR = color(90, 171, 221)--color(27, 169, 222)
	local GRID_COLOR = color(73, 95, 154)--color(33, 97, 195)--BrickColor.new('Deep blue').Color--color(34, 131, 222)
	...
	local getIcon; do
		local skip = { 4,   8,   9,  13,  70, 100, 122, 135, 139, 152, 161, 162, 194,
			...
			1192,1193,1194,1195,1196,1197,1198,1199,1200,1201,1202,1203,1204,1205,1206,1207,1208,1209,1210,1211,1212,1217,1232,1241,1248,1249,1251,1284,1304,1322,1334,1335,1336,1337,1338,1339,1340,1341,1342,1343,1344,1345,1346,1347,1348,1349,1350,1351,1352}
	...
	function pokedex:open()
		...
		if not gui then
			...
			local outerBorder = _p.RoundedFrame:new {
				BackgroundColor3 = color(238, 52, 58),
			...
			local innerBorder = _p.RoundedFrame:new {
				BackgroundColor3 = color(147, 19, 35),
			...
			write '+' {
				...
				}, Scale = true, Color = color(60, 149, 76),
			}
			do
