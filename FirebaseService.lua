local defaultDatabase = "https://projectbronzever-default-rtdb.europe-west1.firebasedatabase.app/" --// Database URL
local authenticationToken = "C2TELiHD8uhRxz0AMYZndboKCXxlsiRSE7BGYUSA "; --// Authentication Token
