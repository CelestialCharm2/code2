return function(_p)--local _p = require(script.Parent.Parent)--game:GetService('ReplicatedStorage').Plugins)
	...
	local gui, bg, close, xpbar, eggs, buttons, CodesTextBox, CodesFrame
	local openThread
	...
	function powers:open()
		...
		if not gui then
			...
			gui = create 'ImageLabel' { -- 650x400
				...
				Image = 'rbxassetid://12983767398', --342679586
				...
				create 'Frame' {
					...
					create 'ImageLabel' {
						BackgroundTransparency = 1.0,
						Image = 'rbxassetid://12983771873',--383165720
			...
			local button3 = create 'ImageButton' { -- 150x100
				BackgroundTransparency = 1.0,
				Image = 'rbxassetid://12983779993',--290486212',
