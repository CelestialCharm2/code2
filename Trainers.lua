...
local eyesMeet1 = {18721794388, 18721794388}
local eyesMeet2 = {18721799255, 18721799255}
local eyesMeet3 = {18721801814, 18721801814}
	...
	Battles = {
		...
		{ -- [#107] : Mitas Laboratory - Jake
			...
			onComplete = function(PlayerData)
				...
				PlayerData:heal()
				PlayerData:addBagItems({id = 'pokeball', quantity = 5})
			end
		},
		...
		{ -- [#220] : Elite 4 Teku
			...
			TrainerDifficulty = 6,
			Payout = 210 * 32,
			LosePhrase = {'You bent me easily.'},
			Party = {
				{ name = 'Aggron', level = 90, item = 'leftovers', ability = 'heavymetal', nature = 'Calm',
					ivs = {31, 31, 31, 31, 31, 31},
					evs = {252, 4, 0, 0, 252, 0},
					moves = {
						{ id = 'curse' },{ id = 'rest' },
						{ id = 'heavyslam' },{ id = 'earthquake' },
					}},
				{ name = 'Aegislash', level = 90, item = 'weaknesspolicy', ability = 'stancechange', nature = 'Adamant',
					ivs = {31, 31, 31, 31, 31, 31},
					evs = {252, 252, 0, 0, 4, 0},
					moves = {
						{ id = 'sacredsword' },{ id = 'shadowball' },
						{ id = 'swordsdance' },{ id = 'kingsshield' },
					}},
				{ name = 'Magearna', level = 90, item = 'assaultvest', ability = 'soulheart', nature = 'Modest',
					ivs = {31, 31, 31, 31, 31, 31},
					evs = {4, 0, 0, 252, 252, 0},
					moves = {
						{ id = 'dazzlinggleam' },{ id = 'aurasphere' },
						{ id = 'drainingkiss' },{ id = 'steelbeam' },
					}},
				{ name = 'Zacian', level = 90, item = 'rustedsword', ability = 'intrepidsword', nature = 'Adamant', forme = 'Crowned',
					ivs = {31, 31, 31, 31, 31, 31},
					evs = {4, 252, 0, 0, 0, 252},
					moves = {
						{ id = 'closecombat' },{ id = 'playrough' },
						{ id = 'crunch' },{ id = 'ironhead' },
					}},
				{ name = 'Excadrill', level = 90, item = 'lifeorb', ability = 'moldbreaker', nature = 'Jolly',
					ivs = {31, 31, 31, 31, 31, 31},
					evs = {0, 252, 0, 0, 0, 252},
					moves = {
						{ id = 'earthquake' },{ id = 'ironhead' },
						{ id = 'swordsdance' },{ id = 'rockslide' },
					}},
				{ name = 'Lucario', level = 90, item = 'Lucarionite', ability = 'steadfast', shiny = true, nature = 'Timid',
					ivs = {31, 31, 31, 31, 31, 31},
					evs = {0, 0, 0, 252, 4, 252},
					moves = {
						{ id = 'dragonpulse' },{ id = 'aurasphere' },
						{ id = 'nastyplot' },{ id = 'flashcannon' },
					}},
			},
			onWin = function(PlayerData)
				PlayerData:completeEventServer('Teku')
			end
		...
		{ -- [#221] : Elite 4 Jay
			...
			TrainerDifficulty = 6,
			Payout = 200 * 100,
			LosePhrase = {'What an amazing trainer!'},
			Party = {
				{ name = 'Whimsicott', level = 90, item = 'focussash', ability = 'prankster', nature = 'Timid',
					ivs = {31, 31, 31, 31, 31, 31},
					evs = {0, 0, 0, 252, 4, 252},
					moves = {
						{ id = 'moonblast' },{ id = 'energyball' },
						{ id = 'tailwind' },{ id = 'encore' },
					}},
				{ name = 'Xerneas', level = 90, item = 'powerherb', ability = 'fairyaura', nature = 'Modest',
					ivs = {31, 0, 31, 31, 31, 31},
					evs = {0, 0, 168, 252, 0, 88},
					moves = {
						{ id = 'geomancy' },{ id = 'moonblast' },
						{ id = 'thunder' },{ id = 'focusblast' },
					}},
				{ name = 'Tapu Fini', level = 90, item = 'leftovers', ability = 'mistysurge', nature = 'Calm',
					ivs = {31, 31, 31, 0, 31, 31},
					evs = {248, 0, 16, 12, 40, 192},
					moves = {
						{ id = 'defog' },{ id = 'moonblast' },
						{ id = 'scald' },{ id = 'taunt' },
					}},
				{ name = 'Mimikyu', level = 90, item = 'lifeorb', ability = 'disguise', nature = 'Jolly',
					ivs = {31, 31, 31, 0, 31, 31},
					evs = {4, 252, 0, 0, 0, 252},
					moves = {
						{ id = 'playrough' },{ id = 'shadowclaw' },
						{ id = 'swordsdance' },{ id = 'woodhammer' },
					}},
				{ name = 'Sylveon', level = 90, item = 'choicespecs', ability = 'Pixilate', nature = 'Modest',
					ivs = {31, 31, 31, 31, 31, 31},
					evs = {252, 0, 0, 252, 4, 0},
					moves = {
						{ id = 'hypervoice' },{ id = 'mysticalfire' },
						{ id = 'calmmind' },{ id = 'protect' },
					}},
				{ name = 'Gardevoir', level = 90, item = 'Gardevoirite', ability = 'Pixilate', shiny = true, nature = 'Timid',
					ivs = {31, 31, 31, 31, 31, 31},
					evs = {0, 0, 0, 252, 4, 252},
					moves = {
						{ id = 'moonblast' },{ id = 'psychic' },
						{ id = 'shadowball' },{ id = 'thunderbolt' },
					}},
			},
			onWin = function(PlayerData)
				PlayerData:completeEventServer('Jay')
			end
		...
		{ -- [#222] : Elite 4 Ethn
			...
			TrainerDifficulty = 6,
			Payout = 250 * 100,
			LosePhrase = {'My muscles didn\'t help.'},
			Party = {
				{ name = 'Lucario', level = 90, item = 'lifeorb', ability = 'innerfocus', nature = 'Timid',
					ivs = {31, 31, 31, 31, 31, 31},
					evs = {0, 0, 0, 252, 4, 252},
					moves = {
						{ id = 'aurasphere' },{ id = 'flashcannon' },
						{ id = 'rest' },{ id = 'sleeptalk' },
					}},
				{ name = 'Marshadow', level = 90, item = 'rockyhelmet', ability = 'technician', nature = 'Jolly',
					ivs = {31, 31, 31, 31, 31, 31},
					evs = {0, 252, 0, 0, 4, 252},
					moves = {
						{ id = 'spectraltheif' },{ id = 'revenge' },
						{ id = 'assurance' },{ id = 'icepunch' },
					}},
				{ name = 'Toxicroak', level = 90, item = 'poisonbarb', ability = 'poisontouch', nature = 'Jolly',
					ivs = {31, 31, 31, 31, 31, 31},
					evs = {0, 252, 0, 0, 4, 252},
					moves = {
						{ id = 'poisonjab' },{ id = 'drainpunch' },
						{ id = 'knockoff' },{ id = 'icepunch' },
					}},
				{ name = 'Quaquaval', level = 90, item = 'leftovers', ability = 'Moxie', nature = 'Adamant',
					ivs = {31, 31, 31, 31, 31, 31},
					evs = {252, 252, 0, 0, 4, 0},
					moves = {
						{ id = 'wavecrash' },{ id = 'closecombat' },
						{ id = 'roost' },{ id = 'aquajet' },
					}},
				{ name = 'Kommo-o', level = 90, item = 'leftovers', ability = 'overcoat', nature = 'Modest',
					ivs = {31, 31, 31, 31, 31, 31},
					evs = {0, 0, 0, 252, 4, 252},
					moves = {
						{ id = 'clangingscales' },{ id = 'clangoroussoul' },
						{ id = 'aurasphere' },{ id = 'flashcannon' },
					}},
				{ name = 'Blaziken', level = 90, item = 'Blazikenite', ability = 'speedboost', shiny = true, nature = 'Adamant',
					ivs = {31, 31, 31, 31, 31, 31},
					evs = {0, 252, 0, 0, 4, 252},
					moves = {
						{ id = 'flareblitz' },{ id = 'brickbreak' },
						{ id = 'earthquake' },{ id = 'thunderpunch' },
					}},
			},
			onWin = function(PlayerData)
				PlayerData:completeEventServer('Ethn')
			end
		...
		{ -- [#223] : Elite 4 Lance
			...
			TrainerDifficulty = 5,
			Payout = 300 * 100,
			LosePhrase = {'My beasts... and altaria... lost?'},
			Party = {
				{ 
					name = 'Salamence', level = 90, item = 'dragonfang',
					ivs = {31, 31, 31, 31, 31, 31},
					moves = { 
						{ id = 'dragonclaw' },{ id = 'earthquake' },
						{ id = 'dracometeor' }, { id = 'flamethrower' },
					},	

					ability = 'Intimidate', nature = 'Hasty'
				},
				{ 
					name = 'Zekrom', level = 90, item = 'lifeorb',
					ivs = {31, 31, 31, 31, 31, 31},
					moves = { 
						{ id = 'honeclaws' },{ id = 'boltstrike' },
						{ id = 'outrage' }, { id = 'substitute' },
					},	

					ability = 'Teravolt', nature = 'Adamant'
				},
				{ 
					name = 'Garchomp', level = 90, item = 'rockyhelmet',
					ivs = {31, 31, 31, 31, 31, 31},
					moves = { 
						{ id = 'earthquake' },{ id = 'liquidation' },
						{ id = 'dragonclaw' }, { id = 'doubleedge' },
					},	

					ability = 'Rough Skin', nature = 'Adamant'
				},
				{ 
					name = 'Dragapult', level = 90, item = 'focussash',
					ivs = {31, 31, 31, 31, 31, 31},
					moves = { 
						{ id = 'phantomforce' },{ id = 'psychicfangs' },
						{ id = 'dragondarts' }, { id = 'uturn' },
					},	

					ability = 'Infiltrator', nature = 'Jolly'
				},
				{ 
					name = 'Dragalge', level = 90, item = 'assaultvest',
					ivs = {31, 31, 31, 31, 31, 31},
					moves = { 
						{ id = 'dragonpulse' },{ id = 'sludgebomb' },
						{ id = 'focusblast' }, { id = 'icywind' },
					},	

					ability = 'Adaptability', nature = 'Modest'
				},
				{ 
					name = 'Altaria', level = 90, item = 'altarianite',
					ivs = {31, 31, 31, 31, 31, 31},
					moves = { 
						{ id = 'moonblast' },{ id = 'dragonpulse' },
						{ id = 'heatwave' }, { id = 'icebeam' },
					},	

					ability = 'Cloud Nine', nature = 'Modest', shiny = true,
				},
			},
			onWin = function(PlayerData)
				PlayerData:completeEventServer('Firebase')
			end
		...
		{ -- [#224] : Champion Brad
			...
			TrainerDifficulty = 7,
			Payout = 900 * 100,
			LosePhrase = {'Congratulations! You are the new Champion.'},
			Party = {
				{ name = 'Ho-oh', level = 100, item = 'heavydutyboots', ability = 'regenerator', nature = 'Impish', shiny = true,
					ivs = {31, 31, 31, 31, 31, 31},
					evs = {248, 208, 0, 0, 52, 0},
					moves = {
						{ id = 'sacredfire' },{ id = 'defog' },
						{ id = 'toxic' },{ id = 'bravebird' },
					}},
				{ name = 'Volcarona', level = 100, item = 'heavydutyboots', ability = 'flamebody', nature = 'Timid',
					ivs = {31, 31, 31, 31, 31, 31},
					evs = {0, 0, 0, 252, 4, 252},
					moves = {
				...
				{ name = 'Lapras', level = 100, item = 'heavydutyboots', ability = 'waterabsorb', nature = 'Calm',
					ivs = {31, 31, 31, 31, 31, 31},
					evs = {248, 0, 8, 0, 252, 0},
					moves = {
						{ id = 'sheercold' },{ id = 'horndrill' },
						{ id = 'rest' },{ id = 'toxic' },
					}},
				{ name = 'Regieleki', level = 100, item = 'lifeorb', ability = 'Transistor', nature = 'Adamant',
					ivs = {31, 31, 31, 31, 31, 31},
					evs = {0, 252, 0, 0, 4, 252},
					moves = {
						{ id = 'rapidspin' },{ id = 'wildcharge' },
						{ id = 'assurance' },{ id = 'explosion' },
					}},
				{ name = 'Charizard', level = 100, item = 'charizarditex', ability = 'Blaze', nature = 'Jolly',
					ivs = {31, 31, 31, 31, 31, 31},
					evs = {0, 252, 0, 0, 4, 252},
					moves = {
						{ id = 'dragondance' },{ id = 'flareblitz' },
						{ id = 'earthquake' },{ id = 'dragonclaw' },
					}},
				{ name = 'Arceus', level = 100, item = 'leftovers', ability = 'multitype', nature = 'Adamant',
					ivs = {31, 31, 31, 31, 31, 31},
					evs = {248, 252, 0, 0, 4, 16},
					moves = {
						{ id = 'swordsdance' },{ id = 'extremespeed' },
						{ id = 'shadowclaw' },{ id = 'recover' },
					}},

			},
			onWin = function(PlayerData)
				PlayerData:winGymBadge(9)
				PlayerData:completeEventServer('BeatChampion')
				PlayerData:completeEventServer('Brad')
			end
		...
		{ -- [#225] : GalaXYZ
			...
			LosePhrase = {''},
			Party = {
				{ name = 'Hatterene', level = 80,ability = 'magicbounce',nature = 'Quiet', item = 'lightclay', 
					ivs = {31, 31, 31, 31, 31, 31},
					evs = {252, 0, 0, 252, 4, 0},
					moves = {
						{ id = 'trickroom' },{ id = 'flamethrower' },
						{ id = 'drainingkiss' }, { id = 'calmmind' },
					}},
				{ name = 'Conkelldur', level = 80,ability = 'Guts',nature = 'Brave', item = 'flameorb', 
					ivs = {31, 31, 31, 31, 31, 31},
					evs = {252, 252, 4, 0, 0, 0},
					moves = {
						{ id = 'icepunch' },{ id = 'wildcharge' },
						{ id = 'firepunch' }, { id = 'earthquake' },
					}},
				{ name = 'Malamar',level = 80,ability = 'contrary',nature = 'Brave', item = 'leftovers', 
					ivs = {31, 31, 31, 31, 31, 31},
					evs = {126, 252, 126, 0, 0, 0},
					moves = {
						{ id = 'superpower' },{ id = 'psychocut' },
						{ id = 'storedpower' }, { id = 'recover' },
					}},
				{ name = 'Blaziken', level = 80,ability = 'speedboost ',nature = 'Adamant', item = 'lifeorb', 
					ivs = {31, 31, 31, 31, 31, 31},
					evs = {4, 252, 0, 0, 0, 252},
					moves = {
						{ id = 'highjumpkick' },{ id = 'swordsdance' },
						{ id = 'flareblitz' }, { id = 'icepunch ' },
					}},
				{ name = 'Polteageist', level = 80,ability = 'cursedbody ',nature = 'Timid', item = 'shellbell', 
					ivs = {31, 31, 31, 31, 31, 31},
					evs = {4, 0, 0, 252, 0, 252},
					moves = {
						{ id = 'shellsmash' },{ id = 'shadowball' },
						{ id = 'focusblast' }, { id = 'protect' },
					}},
			},
		...
		{ -- [#226] : Bounty
			...
			LosePhrase = {''},
			Party = {
				{ name = 'Pelipper', level = 80,ability = 'drizzle',nature = 'Timid', item = 'lifeorb', 
					ivs = {31, 31, 31, 31, 31, 31},
					evs = {0, 0, 0, 252, 4, 252},
					moves = {
						{ id = 'hurricane' },{ id = 'hydropump' },
						{ id = 'u-turn' }, { id = 'protect' },
					}},
				{ name = 'Electivire  ', level = 80,ability = 'Vital Spirit',nature = 'Adamant', item = 'lifeorb', 
					ivs = {31, 31, 31, 31, 31, 31},
					evs = {0, 252, 0, 0, 0, 252},
					moves = {
						{ id = 'icepunch' },{ id = 'wildcharge' },
				...
				{ name = 'Rotom', forme = 'wash',level = 80,ability = 'Levitate',nature = 'Bold', item = 'leftovers', 
					ivs = {31, 31, 31, 31, 31, 31},
					evs = {0, 0, 0, 252, 0, 252},
					moves = {
						{ id = 'scald' },{ id = 'thunderbolt' },
						{ id = 'toxic' }, { id = 'painsplit' },
					}},
				{ name = 'Vaporeon', level = 80,ability = 'hydration ',nature = 'modest', item = 'leftovers', 
					ivs = {31, 31, 31, 31, 31, 31},
					evs = {252, 0, 128, 0, 128, 0},
					moves = {
						{ id = 'scald' },{ id = 'toxic' },
						{ id = 'protect' }, { id = 'icebeam ' },
					}},
				{ name = 'Gengar', level = 80,ability = 'levitate ',nature = 'Timid', item = 'Gengarite', 
					ivs = {31, 31, 31, 31, 31, 31},
					evs = {0, 0, 0, 252, 0, 252},
					moves = {
						{ id = 'thunderbolt' },{ id = 'psychic' },
						{ id = 'dazzlinggleam' }, { id = 'energyball' },
					}},
			},
		...
		{ -- [#229] : Rex
			...
			TrainerDifficulty = 5,
			Payout = 50 * 100,
			LosePhrase = {'Impossbile'},
			Party = {
				{ name = 'Alakazam', level = 85},
				{ name = 'Hypno', level = 85},
		...
		{ -- [#230] : Jessie
			...
			LosePhrase = {'Impossbile'},
			Party = {
				{ name = 'Weavile', level = 85},
				{ name = 'Scizor', level = 85},
				{ name = 'Zoroark', level = 85, forme = 'Hisui'},
			},
		...
		{ -- [#231] : Cyris
			...
			TrainerDifficulty = 5,
			Payout = 100 * 100,
			LosePhrase = {'WHAT NOOB'},
			Party = {
				{ name = 'Quagsire', level = 90},
				{ name = 'Umbreon', level = 90},
				{ name = 'Arcanine', level = 90},
				{ name = 'Metagross', level = 90, item = 'metagrossite'},
			},
		...
		{ -- [#232] : Gym 8 - Captain B
			...
			LosePhrase = 'This loss has me spooked. How did you beat me?',
			Party = {
				{ name = 'Gengar', level = 81, item = 'focussash'},
				{ name = 'Decidueye', level = 81, item = 'lifeorb'},
				{ name = 'Spiritomb', level = 81, item = 'leftovers'},
				{ name = 'Mismagius', level = 81, item = 'lifeorb'},
				{ name = 'Aegislash', level = 82, item = 'weaknesspolicy'},
				{ name = 'Sableye', item = 'sablenite', level = 83},
			},
			onWin = function(PlayerData)
				if not PlayerData.badges[8] then
					PlayerData:winGymBadge(8, 65)
				end
			end
		},
		{ -- [#233] : Truth
			...
			TrainerDifficulty = 5,
			Payout = 0,
			LosePhrase = {'This... could be the end....'},
			Party = {
				{ name = 'Kyurem', level = 80, forme = 'Whiteoverdrive'
				},
			},
		...
		{--[#235] : Pirate Smitty
			...
			IntroPhrase = {'Findin\' yer way \' round the ship can be tricky.', 'Even if ye can solve our tricky puzzle, will ye be ready to take on our captain?', 'Let\'s find out.'},
			LosePhrase = 'Yer tough, but are ye ready?',
			Interact = {'Is what yer seeing real, or an illusion?', 'The power of the Ghost type can make reality seem more like a dream.'},
			Party = {
				{name = 'Gourgeist', level = 75},
				{name = 'Trevenant', level = 75}
			}
		...
		{--[#236] : Pirate Mary
			...
			IntroPhrase = {'Are you lost yet?','The ship\'s final test may be its leader, but navigating the ship is a test in itself.'},
			LosePhrase = 'Now I am the one that is confused.',
			Interact = {'If you pay attention to the colors on the borders when arranging the ship\'s tiles, you\'ll know which edges connect when the cube is folded.'},
			Party = {
				{name = 'Golurk', level = 75},
				{name = 'Dhelmise', level = 75}
			}
		...
		{--[#237] : Pirate Peterson
			...
			IntroPhrase = {'Do ghost stories scare you?', 'Let me share one with you.'},
			LosePhrase = 'This story had a sad ending.',
			Interact = {'What happens on this ship is scarier than anything you\'ve ever read in books.'},
			Party = {
				{name = 'Drifblim', level = 75},
				{name = 'Palossand', level = 75}
			}
