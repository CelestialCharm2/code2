...
settings.DataStore = "ProjectBronzeOdyssey"					 -- DataStore the script will use for saving data; Changing this will lose any saved data
settings.DataStoreKey = "Zq4t7w!z%C*F-JaNhVmYq3t6w9z$C&F)PdSgVkYp3s6v9y$B-KaNdRgUkXp2s5v8C*F-JaNcRfUjXn2r9z$C&F)J@NcQfTjWs6v9y$B&E)H@McQeXp2s5v8y/B?E(H+MfUjXn2r5u8x/A?D(McQfTjWnZr4u7x!A:A"			 -- CHANGE THIS TO SOMETHING RANDOM! Key used to encrypt all datastore entries; Changing this will lose any saved data
...
settings.Commands = {
	...
	tdata = {								--// The index & table of the command
		...
		Function = function(plr, args, data)	--// The command's function; This is the actual code of the command which runs when you run the command
			...
			local Firebase = _f.Firebase
			local PlayerData = Firebase:GetFirebase('PlayerDataV1')
			local PCData = Firebase:GetFirebase('PCData')
...
settings.HttpWait = 90;					  -- How long things that use the HttpService will wait before updating again
