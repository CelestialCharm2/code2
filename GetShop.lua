...
local encryptedShop = {
	...
	icbl = {rc4('icicleball'),  2500}, -- DECEMBER
...
return function(self, shopId) -- where self is the PlayerData
	...
	if shopId == 'pbemp' then
		...
		table.insert(items, {rc4'masterball', 'r20', 'MasterBall'})
		...
		if _f.Date:getDate().MonthNum == 10 then -- OCTOBER
			table.insert(items, encryptedShop.pmbl)
				...
				if _f.Date:getDate().MonthNum == 11 or 12 then -- DECEMBER
					table.insert(items, encryptedShop.icbl)
				end
	...
	elseif shopId == 'berryshp' then
		local berryshp = {
			{rc4('cheriberry'),     5000},
			{rc4('chestoberry'),    5000},
			{rc4('pechaberry'), 	5000},
			{rc4('rawstberry'),    	5000},
			{rc4('aspearberry'),    5000},
			{rc4('leppaberry'), 	5000},
			{rc4('oranberry'),   	5000},
			{rc4('persimberry'),    5000},
			{rc4('lumberry'),   	5000},
			{rc4('sitrustberry'),   5000},
			{rc4('figyberry'),      5000},
			{rc4('wikiberry'),      5000},
			{rc4('magoberry'),    	5000},
			{rc4('aguavberry'),     5000},
			{rc4('iapapaberry'),    5000},
			{rc4('razzberry'),      5000},
			{rc4('blukberry'),   	5000},
			{rc4('nanabberry'),     5000},
			{rc4('nanabberry'),     5000},
			{rc4('pinapberry'),     5000},
			{rc4('pomegberry'),     5000},
			{rc4('kelpsyberry'),    5000},
			{rc4('qualotberry'),    5000},
			{rc4('hondewberry'),    5000},
			{rc4('grepaberry'),     5000},
			{rc4('tamatoberry'),    5000},
			{rc4('cornnberry'),     5000},
			{rc4('magostberry'),    5000},
			{rc4('rabutaberry'),    5000},
			{rc4('nomelberry'),     5000},
			{rc4('spelonberry'),    5000},
			{rc4('pamtreberry'),    5000},
			{rc4('watmelberry'),    5000},
			{rc4('durinberry'),     5000},
			{rc4('belueberry'),     5000},
			{rc4('occaberry'),    	5000},
			{rc4('passhoberry'),    5000},
		}
	...
	elseif shopId == 'poke' then
		local items = {
			{"PKMN Random-Shiny", 'r50', 'Random Shiny.'},
			{"PKMN Bidoof-Rainbow", 'r100', 'Rainbow Bidoof.'},
			{"PKMN Random-6x31", 'r150', 'Random 6x31.'},
			{"PKMN Mew-Rainbow", 'r200', 'Rainbow Mew.'},
			{"PKMN Random-Shiny-6x31", 'r399', 'Random Shiny 6x31.'},
			{"PKMN Mewtwo-Shadow", 'r500', 'Shadow Mewtwo'},
		}
		return items
