...
local Audios = require(game:GetService('ServerScriptService'):WaitForChild('Audios'))
...
local function EncounterList(list)
	...
	local function modList(list)
		...
		--list[#list+1] = {'Cinderace', minLevel, maxLevel, totalWeight/2000, nil, true, 'Pirate'}
		--list[#list+1] = {'Bidoof', 1, 25, totalWeight/500, nil, true, 'Irish'}
		--list[#list+1] = {'Lopunny', minLevel, maxLevel, totalWeight/500, nil, true, 'E'}
		--list[#list+2] = {'Togekiss', minLevel, maxLevel, totalWeight/500, nil, true, 'E'}
		--list[#list+3] = {'Azumarill', minLevel, maxLevel, totalWeight/250, nil, true, 'E'}
	end
...
--					{'Mimikyu',    4, 6,  3, 'night', nil, nil, 'chestoberry', 20}, -- Halloween 2022
	...
	['chunk9'] = {
		...
		regions = {
			['Lagoona Lake'] = {
				SignColor = BrickColor.new('Deep blue').Color,
				Music = {Audios.LagoonaLake1, Audios.LagoonaLake2},
				OldRod = OldRodList {
					{'Magikarp', 50},
		...
		regions = {
			['Route 9'] = {
				...
				Grass = EncounterList {
					...
					{'Rabsca',  22, 25, 25, nil, false, nil, 'poisonbarb', 20},
	...
	['BattleFrontier'] = {
		...
		regions = {
			['Anthian City - Battle Frontier'] = {
				blackOutTo = 'chunk21',
				SignColor = BrickColor.new('Crimson').Color,
				BattleScene = 'CreeksDay',
				Music = 16991530566,
			}
		}
	},
	...
	['chunkZygardeTest'] = {
		...
		regions = {
			['Zygarde'] = {
				SignColor = BrickColor.new('Lime green').Color,
				Music = Audios.GlisteningGrotto,
				MusicVolume = .45,
				BattleScene = 'CrystalCave',
				RodScene = 'CrystalCave',
	...
	['chunk28'] = {blackOutTo = 'chunk25', canFly = false, regions = {c = {NoSign = true, Music = Audios.chunk28, BattleScene = 'DesertCastleRuins', RTDDisabled = true, GrassNotRequired = true, GrassEncounterChance = 1, Grass = ruinsEncounter}}},
	['chunk29'] = {blackOutTo = 'chunk25', canFly = false, regions = {c = {NoSign = true, Music = Audios.chunk29, BattleScene = 'DesertCastleRuins', RTDDisabled = true, GrassNotRequired = true, GrassEncounterChance = 1, Grass = ruinsEncounter}}},
	['chunk30'] = {blackOutTo = 'chunk25', canFly = false, regions = {c = {NoSign = true, Music = Audios.chunk30, BattleScene = 'DesertCastleRuins', RTDDisabled = true, GrassNotRequired = true, GrassEncounterChance = 1, Grass = ruinsEncounter}}},
	['chunk31'] = {blackOutTo = 'chunk25', canFly = false, regions = {c = {NoSign = true, Music = Audios.chunk31, BattleScene = 'DesertCastleRuins', RTDDisabled = true, GrassNotRequired = true, GrassEncounterChance = 1, Grass = ruinsEncounter}}},
	['chunk32'] = {blackOutTo = 'chunk25', canFly = false, regions = {c = {NoSign = true, Music = Audios.chunk32, BattleScene = 'DesertCastleRuins', RTDDisabled = true, GrassNotRequired = true, GrassEncounterChance = 1, Grass = ruinsEncounter}}},
	['chunk33'] = {blackOutTo = 'chunk25', canFly = false, regions = {c = {NoSign = true, Music = Audios.chunk33, BattleScene = 'DesertCastleRuins', RTDDisabled = true, GrassNotRequired = true, GrassEncounterChance = 1, Grass = ruinsEncounter}}},
	['chunk34'] = {blackOutTo = 'chunk25', canFly = false, regions = {c = {NoSign = true, Music = Audios.chunk34, BattleScene = 'DesertCastleRuins', RTDDisabled = true, GrassNotRequired = true, GrassEncounterChance = 1, Grass = ruinsEncounter,
	...
	['gym5'] = {
		...
		regions = {
			['Aredia City Gym'] = {
				...
				NoSign = true,
				noPCBox = true,
				Music = {Audios.ArediaCityGym1, Audios.ArediaCityGym2},
				BattleScene = 'Gym5'
			}
		}
	},
	...
	['chunk44'] = {
		...
		regions = {
			['Cragonos Sanctuary'] = {
				...
				Music = Audios.CragonosSanctuary,
			}
		}
	},
	['chunk45'] = {
	...
	['chunk49'] = {
		...
		regions = {
			['Martensite Chamber'] = {
				...
				Music = Audios.MartensiteChamber,
				IsDark = true,
	...
	['chunk55'] = {
		...
		regions = {
			['Cosmeos Observatory'] = {
				Music = Audios.CosmeosObservatory,
				MusicVolume = routeMusicVolume,
			},
		},
	},
	...
	['chunk56'] = {
		...
		regions = {
			['Tinbell Construction Site'] = {
				...
				Music = Audios.TinbellConstructionSite,
				MusicVolume = 1,
			},
			['Tinbell Tower'] = {
	...
	['chunk90'] = {
		...
		regions = {
			['Roria Safari Zone'] = {
				...
				Zelda = EncounterList {Locked = true} {{'Honedge', 30, 30, 1, nil, nil, 'Master'}}
	...
	['chunk77'] = {
		...
		regions = {
			['Eclipse Base - Entrance Hall'] = {
				...
				RTDDisabled = true,
				canFly = true,
				Music = Audios.EclipseBaseEntranceHall,
	...
	['chunk78'] = {
		...
		regions = {
			['Eclipse Base - Cafeteria'] = {
				SignColor = BrickColor.new('Bright orange').Color,
				RTDDisabled = true,
				Music = Audios.EclipseBaseCafeteria,				BattleScene = 'EclipseCafeteria'
			}
		}
	},
	...
	['chunk79'] = {
		...
		regions = {
			['Eclipse Base - Power Station'] = {
				SignColor = BrickColor.new('Bright orange').Color,
				RTDDisabled = true,
				Music = Audios.EclipseBasePowerStation,
	...
	['chunk80'] = {
		...
		regions = {
			['Eclipse Base - Living Quarters'] = {
				SignColor = BrickColor.new('Bright orange').Color,
				RTDDisabled = true,
				Music = Audios.EclipseBaseLivingQuarters,
	...
	['chunk81'] = {
		...
		regions = {
			['Eclipse Base - Surveillance Room'] = {
				SignColor = BrickColor.new('Bright orange').Color,
				RTDDisabled = true,
				Music = Audios.EclipseBaseSurveillanceRoom,
			}
		}
	},
	...
	['chunk82'] = {
		...
		regions = {
			["Eclipse Base - Cypress' Office"] = {
				SignColor = BrickColor.new('Bright orange').Color,
				RTDDisabled = true,
				Music = Audios.EclipseBaseCypressOffice,
			}
		}
	},
	...
	['chunk83'] = {
		...
		regions = {
			['Eclipse Base - Prison Cells'] = {
				SignColor = BrickColor.new('Bright orange').Color,
				RTDDisabled = true,
				Music = Audios.EclipseBaseCypressOfficePrisonCells,
			}
		}
	},
	...
	['chunk84'] = {
		...
		regions = {
			['Eclipse Base - Aircraft Hangar'] = {
				SignColor = BrickColor.new('Bright orange').Color,
				RTDDisabled = true,
				Music = Audios.EclipseBaseAircraftHangar,
			}
		}
	},
	...
	['resort'] = {
		...
		regions = {
			['Trade Resort'] = {
				...
				Music = {Audios.TradeResort1, Audios.TradeResort2}, --11322838239, -- 2021 X-Mass Event
				--MusicVolume = 1, -- 2021 X-Mass Event				
				MusicVolume = 1,
			}
		}
	},
