...
do -- Data Setup
	local cryIds = { 17475409267, 17475405913, 17475407378, 17475412890, 17475412890,--// Cries 1-5
		17475411422, 17475412222, 17475410294, 17475414634, 17475407935,--// Cries 6-10
		17475408453, 17475406825, 17475404642, 17475404321, 17475409733,--// Cries 11-15
		17475413926, 17475405321, 17475405321 }--// Cries 16 & 17
	...
	for _, s in pairs(data.GifData) do
		local p = s.Salamence
		s['Roaring Moon'].scale = .8
		p.scale = 1
		local g = s.Qwilfish
		s['Qwilfish-Hisuian'].scale = .635
		g.scale = 1
	end
