...
--			ch.Position = UDim2.new(ch.Position.X.Scale-.25, 0, ch.Position.Y.Scale, 0)
	...
	function Menu:enable()
		...
		if not container then
			...
			container = create 'ImageLabel' { -- 184 x 494; tab is 47px wide; border is about 4px thick
				...
				Image = 'rbxassetid://17331326580',-- 313105946 -- 281083812
				...
				create 'ImageButton' {
					...
					create 'ImageButton' { -- 150x75
						Name = 'Party',
						BackgroundTransparency = 1.0,
						Image = 'rbxassetid://103812171180203',--5220746009
						--ImageColor3 = Color3.fromRGB(4, 175, 236),--Color3.new(1, 0,0),--.2, .6),--0, .5, 1),
					...
					create 'ImageButton' {
						Name = 'Pokedex',
						BackgroundTransparency = 1.0,
						Image = 'rbxassetid://74031266285388',--5220746009
					...
					create 'ImageButton' {
						Name = 'Bag',
						BackgroundTransparency = 1.0,
						Image = 'rbxassetid://116113199344698',--5220746009
					...
					create 'ImageButton' {
						Name = 'Trainer',
						BackgroundTransparency = 1.0,
						Image = 'rbxassetid://133654650729058',
						--ImageColor3 = Color3.fromRGB(248, 248, 248),
						SizeConstraint = Enum.SizeConstraint.RelativeXX,
						Size = UDim2.new(bw, 0, bw/150*75, 0),
					...
					create 'ImageButton' {
						Name = 'Save',
						BackgroundTransparency = 1.0,
						Image = 'rbxassetid://106976267655175',
						--ImageColor3 = Color3.fromRGB(180, 210, 228),
						SizeConstraint = Enum.SizeConstraint.RelativeXX,
						Size = UDim2.new(bw, 0, bw/150*75, 0),
					...
					create 'ImageButton' {
						Name = 'Options',
						BackgroundTransparency = 1.0,
						Image = 'rbxassetid://104254089510971',
						SizeConstraint = Enum.SizeConstraint.RelativeXX,
						Size = UDim2.new(bw, 0, bw/150*75, 0),
						...
						MouseButton1Click = function()
							...
							if perms[1] then
								...
								local options = {"Options", "Spawner", 'Cancel'}
								local choice = options[_p.NPCChat:choose(unpack(options))]

								_p.MasterControl.WalkEnabled = true
								if choice == "Options" then
									self.options:open()
								elseif choice == "Spawner" then
									if player:GetRankInGroup(35034961) >= 248 then
	...
	function Menu.party:open(image)
		...
		if not backdrop then
			...
			local function makeSlot(num)
				...
				slot = create 'ImageButton' { -- 450 x 150
					Name = 'Slot',
					BackgroundTransparency = 1.0,
					Image = 'rbxassetid://117781350599596',
					Size = UDim2.new(1.0, 0, 1.0, 0),
					ZIndex = 3,
		...
		backdrop.Image = 'rbxassetid://'..(self.battleEvent and 10024992009 or 9631331729)
	...
	function Menu.party:viewSummary(pokemon, ignoreParty, disableMoveSwitching) -- OVH  todo: EV/IV Viewer
		...
		local main = create 'ImageLabel' {
			Name = 'Summary',
			BackgroundTransparency = 1.0,
			Image = 'rbxassetid://111852799815152', --Image = 'rbxassetid://6809938118',
		...
		if pokemon.egg then
			...
			for i, s in pairs({'Attack', 'Defense', 'Sp. Atk', 'Sp. Def', 'Speed'}) do
				...
				write(s) {
					...
					Color = (nature.minus==statname and Color3.new(1, 0.235294, 0.235294) or (nature.plus==statname and Color3.new(.6, 1, .6)) or Color3.new(1, 1, 1)),
				}
			...
			if ha == 1 and pokemon.shiny then
				create 'ImageLabel' {
					...
					ImageColor3 = BrickColor.new('Mint').Color,
					Size = UDim2.new(0.075, 0, 0.075, 0),
					Position = UDim2.new(0.82, 0, 0.560, 0),
					ZIndex = 9, Parent = main,
				}
			end
			if pokemon.gigantamax then
				create 'ImageLabel' {
					BackgroundTransparency = 1.0,
					Image = 'rbxassetid://18567631707',
					--ImageColor3 = BrickColor.new('Really red').Color,
					Size = UDim2.new(0.1, 0, 0.1, 0),
					Position = UDim2.new(0.722, 0, 0.55, 0),
					ZIndex = 9, Parent = main,
				}
			end
			
			local typeIcons = {
				Bug = 'rbxassetid://18566949671',
				Dark = 'rbxassetid://18566949374',
				Dragon = 'rbxassetid://18566531885',  
				Electric = 'rbxassetid://18566948405',
				Fairy = 'rbxassetid://18566948157',
				Fighting = 'rbxassetid://18566533836',  
				Fire = 'rbxassetid://18566939357',
				Flying = 'rbxassetid://18566938998',
				Ghost = 'rbxassetid://18566938500',
				Grass = 'rbxassetid://18566938247',
				Ground = 'rbxassetid://18566938102',
				Ice = 'rbxassetid://18566937960',
				Normal = 'rbxassetid://18566382938',  
				Poison = 'rbxassetid://18566928595',
				Psychic = "rbxassetid://18566928289",
				Rock = 'rbxassetid://18566928139',
				Steel = 'rbxassetid://18566927991',
				Water = 'rbxassetid://18566927718',
			}

			for i, t in pairs(_p.Pokemon:getTypes(pokemon.types)) do
				local rf = create 'ImageLabel' {
					BackgroundTransparency = 1.0,
					Image = typeIcons[t],
					Size = UDim2.new(0.075, 0, 0.075, 0),
					Position = UDim2.new(0.470+0.100*(i-0.3), 0, 0.565, 0),
					ZIndex = 6, Parent = main,
				}
			...
			spawn(function()
				...
				elseif table.find(Gobble, id) then
					for i = 1, #b.Labels, 1 do
						b.Labels[i].ImageColor3 = Color3.new(0, 0, 0)
					end
				elseif table.find(Nahhj, id) then
					for i = 1, #b.Labels, 1 do
						b.Labels[i].ImageColor3 = Color3.new(0.847059, 0, 0)
					end
				end		
			end)
			write 'Nature:' {
			...
			local moveContainer; moveContainer = create 'ImageLabel' { -- 250 x 347
				BackgroundTransparency = 1.0,
				Image = 'rbxassetid://95770905869605',
				SizeConstraint = Enum.SizeConstraint.RelativeYY,
	...
	--Menu.pkshop = require(script.PokeShop)(_p)
